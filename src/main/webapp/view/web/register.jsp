            ...
            <div class="auth-form">
                <div class="auth-form__container">
                    <div class="auth-form__header">
                        ...
                        <a href="<c:url value="/web-login"/>" class="login-from__btn auth-form__switch-btn">Login</a>
                    </div>
                    <div class="auth-form__form">
                        <div class="auth-form__group">
                            <input type="mail" class="auth-form__input" placeholder="user name*" required
                                   name="username">
                        </div>
                        <div class="auth-form__group">
                            <input type="mail" class="auth-form__input" placeholder="full name"
                                   name="fullName">
                        </div>
                        <div class="auth-form__group">
                        ...
                        <div class="auth-form__group">
                            <input type="password" class="auth-form__input" id="test3" placeholder="confirm password*"
                                   required
