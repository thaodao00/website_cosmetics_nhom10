...
<body>
<!--modal account-->
<div class="modal-account" style="position: unset; display: flex; padding-bottom: 50px;">
    <div style="background-image: url('template/web/assets/img/slider-3.jpg'); position: absolute; width: 100%; height: 100%;"></div>
    <div class="modal__overlay" style="position: absolute;"></div>
    <div class="modal__body" style="margin-top: 12.5%;">
        <!--Login form -->
