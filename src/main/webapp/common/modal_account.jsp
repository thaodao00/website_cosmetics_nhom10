                ...
                <div class="auth-form__container">
                    ...
                    <div class="auth-form__form">
                        <div class="auth-form__group">
                            <input type="mail" class="auth-form__input" placeholder="User name" name="username">
                        </div>
                        <div class="auth-form__group">
                    ...
                    <div class="auth-form__controls">
                        ...
                        <button type="submit" form="register-form" formmethod="post" formaction="api-register" class="buttons">
                            Register
                        </button>
                    </div>
                </div>
